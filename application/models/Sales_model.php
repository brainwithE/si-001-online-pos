...
class Sales_model extends CI_model{
	...
	function get_daily_sales(){
	    ...
	    $this->db->order_by("sales_id", "desc");
		$this->db->select('sales_id, pos_item.item_name, pos_item.item_supplier, pos_item.item_category, sales_quantity,sales_total, sales_status, sales_discount, sales_date, sales_supplier, sales_st, sales_status');
		$this->db->from('pos_sales');
	...
	function get_sales_certmonth($date_start,$date_end){
		...
		$this->db->select('sales_id, pos_item.item_name, pos_item.item_supplier, pos_item.item_category, sales_quantity,sales_total, sales_status, sales_discount, sales_date, sales_supplier, sales_st');
